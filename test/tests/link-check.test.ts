...
linkCheckTestGroup.add(
    new Test('未启用检查时始终 false', 'async', function () {
...
linkCheckTestGroup.add(
    new Test('空/空值评论返回 false', 'async', function () {
...
linkCheckTestGroup.add(
    new Test('检测已知网盘特征', 'async', function () {
        GM_setValue('checkDownloadLink', true)
...
linkCheckTestGroup.add(
    new Test('大小写不敏感', 'async', function () {
        GM_setValue('checkDownloadLink', true)
...
linkCheckTestGroup.add(
    new Test('普通评论返回 false', 'async', function () {
        GM_setValue('checkDownloadLink', true)
