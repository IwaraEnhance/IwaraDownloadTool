...
import { isNull, isUndefined, isNullOrUndefined, isObject, isString, isNumber, isArray, isNotEmpty, hasFunction, isConvertibleToNumber } from '../../src/core/env.ts'
...
guardTestGroup.add(
    new Test('isNull 识别 null', 'async', function () {
...
guardTestGroup.add(
    new Test('isUndefined 识别 undefined', 'async', function () {
...
guardTestGroup.add(
    new Test('isNullOrUndefined 识别 null 和 undefined', 'async', function () {
...
guardTestGroup.add(
    new Test('isObject 识别对象', 'async', function () {
...
guardTestGroup.add(
    new Test('isString 识别字符串', 'async', function () {
...
guardTestGroup.add(
    new Test('isNumber 识别数字', 'async', function () {
...
guardTestGroup.add(
    new Test('isArray 识别数组', 'async', function () {
...
guardTestGroup.add(
    new Test('isNotEmpty 空值判断', 'async', function () {
...
guardTestGroup.add(
    new Test('isNotEmpty 嵌套数组', 'async', function () {
        this.assertFalse(isNotEmpty([null, undefined, []]))
...
guardTestGroup.add(
    new Test('isNotEmpty 对象属性判断', 'async', function () {
...
guardTestGroup.add(
    new Test('hasFunction 检查对象方法', 'async', function () {
...
guardTestGroup.add(
    new Test('isConvertibleToNumber 可转换数字', 'async', function () {
...
guardTestGroup.add(
    new Test('isConvertibleToNumber Infinity 参数', 'async', function () {
