...
numberTestGroup.add(
    new Test('isPositiveInteger 正整', 'async', function () {
...
numberTestGroup.add(
    new Test('isPositiveInteger 非正整', 'async', function () {
...
numberTestGroup.add(
    new Test('isNegativeInteger 负整', 'async', function () {
...
numberTestGroup.add(
    new Test('isNegativeInteger 非负整', 'async', function () {
...
numberTestGroup.add(
    new Test('isPositiveFloat 正浮点', 'async', function () {
...
numberTestGroup.add(
    new Test('isPositiveFloat 非正浮点', 'async', function () {
...
numberTestGroup.add(
    new Test('isNegativeFloat 负浮点', 'async', function () {
...
numberTestGroup.add(
    new Test('isNegativeFloat 非负浮点', 'async', function () {
...
numberTestGroup.add(
    new Test('isConvertibleNumber 数字', 'async', function () {
...
numberTestGroup.add(
    new Test('isConvertibleNumber 非数字', 'async', function () {
...
numberTestGroup.add(
    new Test('isConvertibleNumber Infinity 参数', 'async', function () {
...
numberTestGroup.add(
    new Test('toPositiveInteger 合法', 'async', function () {
...
numberTestGroup.add(
    new Test('toPositiveInteger 非法抛错', 'async', function () {
...
numberTestGroup.add(
    new Test('toNegativeInteger 合法', 'async', function () {
...
numberTestGroup.add(
    new Test('toNegativeInteger 非法抛错', 'async', function () {
...
numberTestGroup.add(
    new Test('toPositiveFloat 合法', 'async', function () {
...
numberTestGroup.add(
    new Test('toPositiveFloat 非法抛错', 'async', function () {
...
numberTestGroup.add(
    new Test('toNegativeFloat 合法', 'async', function () {
...
numberTestGroup.add(
    new Test('toNegativeFloat 非法抛错', 'async', function () {
...
numberTestGroup.add(
    new Test('isConvertibleNumber 字符串边界', 'async', function () {
        this.assertTrue(Number.isConvertibleNumber('0'))
        this.assertTrue(Number.isConvertibleNumber('-0'))
...
numberTestGroup.add(
    new Test('isConvertibleNumber Infinity 字符串', 'async', function () {
        this.assertFalse(Number.isConvertibleNumber('Infinity'))
        this.assertTrue(Number.isConvertibleNumber('Infinity', true))
    })
)
...
numberTestGroup.add(
    new Test('isPositiveInteger 边界', 'async', function () {
...
numberTestGroup.add(
    new Test('isNegativeInteger 边界', 'async', function () {
