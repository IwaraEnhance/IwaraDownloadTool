...
dictTestGroup.add(new Test('空字典转换', 'async', function () {
...
dictTestGroup.add(new Test('带初始数据的字典', 'async', function () {
    const d = new Dictionary<string>([
        ['key1', 'value1'],
        ['key2', 'value2'],
    ]);
...
dictTestGroup.add(new Test('toArray 方法', 'async', function () {
    const d = new Dictionary<number>([['a', 1], ['b', 2]]);
    const arr = d.toArray();
...
dictTestGroup.add(new Test('keysArray 方法', 'async', function () {
    const d = new Dictionary<string>([['x', '10'], ['y', '20']]);
...
dictTestGroup.add(new Test('valuesArray 方法', 'async', function () {
    const d = new Dictionary<string>([['a', 'foo'], ['b', 'bar']]);
...
dictTestGroup.add(new Test('继承 Map 方法', 'async', function () {
