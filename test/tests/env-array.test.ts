...
arrayTestGroup.add(
    new Test('any 空数组', 'async', function () {
        this.assertFalse([].any())
    })
)

arrayTestGroup.add(
    new Test('any 全空值', 'async', function () {
        this.assertFalse([null, undefined].any())
    })
)

arrayTestGroup.add(
    new Test('any 有非空值', 'async', function () {
...
arrayTestGroup.add(
    new Test('unique 基本去重', 'async', function () {
...
arrayTestGroup.add(
    new Test('unique 字符串去重', 'async', function () {
...
arrayTestGroup.add(
    new Test('unique 属性去重', 'async', function () {
        const arr = [
            { id: 1, name: 'Alice' },
            { id: 2, name: 'Bob' },
            { id: 1, name: 'Alice2' }
...
arrayTestGroup.add(
    new Test('union 基本并集', 'async', function () {
...
arrayTestGroup.add(
    new Test('union 属性并集', 'async', function () {
        const a = [{ id: 1 }, { id: 2 }]
        const b = [{ id: 2 }, { id: 3 }]
...
arrayTestGroup.add(
    new Test('union 空数组', 'async', function () {
...
arrayTestGroup.add(
    new Test('intersect 基本交集', 'async', function () {
...
arrayTestGroup.add(
    new Test('intersect 无交集', 'async', function () {
...
arrayTestGroup.add(
    new Test('intersect 属性交集', 'async', function () {
        const a = [
            { id: 1, name: 'A' },
            { id: 2, name: 'B' }
        ]
...
arrayTestGroup.add(
    new Test('difference 基本差集', 'async', function () {
...
arrayTestGroup.add(
    new Test('difference 无差异', 'async', function () {
...
arrayTestGroup.add(
    new Test('complement 基本补集', 'async', function () {
...
arrayTestGroup.add(
    new Test('complement 相同数组', 'async', function () {
...
arrayTestGroup.add(
    new Test('complement 属性补集', 'async', function () {
        const a = [{ id: 1 }, { id: 2 }]
        const b = [{ id: 2 }, { id: 3 }]
...
arrayTestGroup.add(
    new Test('unique NaN 值', 'async', function () {
...
arrayTestGroup.add(
    new Test('unique 属性含 NaN', 'async', function () {
...
arrayTestGroup.add(
    new Test('unique 混合类型', 'async', function () {
...
arrayTestGroup.add(
    new Test('union 两个空数组', 'async', function () {
        const result = [].union([])
        this.assertEqual(result.length, 0)
    })
)
...
arrayTestGroup.add(
    new Test('intersect 一个空数组', 'async', function () {
...
arrayTestGroup.add(
    new Test('difference 全部相同', 'async', function () {
...
arrayTestGroup.add(
    new Test('complement 完全不同的数组', 'async', function () {
