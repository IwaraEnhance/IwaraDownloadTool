...
pathTestGroup.add(
    new Test('Windows 简单路径', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 根目录路径', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 无扩展名文件', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 多级目录', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 混合分隔符 (正斜杠)', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 末尾斜杠处理', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 重复分隔符合并', 'async', function () {
        const p = new Path('C:\\Users\\\\test\\\\\\file.txt')
        this.assertEqual(p.fullPath, 'C:\\Users\\test\\file.txt')
    })
)
...
pathTestGroup.add(
    new Test('Windows 点导航 (.)', 'async', function () {
        const p = new Path('C:\\Users\\.\\test\\file.txt')
        this.assertEqual(p.fullPath, 'C:\\Users\\test\\file.txt')
    })
)
...
pathTestGroup.add(
    new Test('Windows 点导航 (..) 返回上层', 'async', function () {
        const p = new Path('C:\\Users\\test\\..\\file.txt')
...
pathTestGroup.add(
    new Test('Windows 点导航多层返回', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 绝对路径越界抛错', 'async', function () {
        this.assertThrows(() => new Path('C:\\Users\\..\\..\\..\\file.txt'))
    })
)

pathTestGroup.add(
    new Test('Windows 路径含非法字符', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 路径含变量名中的非法字符', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 路径变量名合法', 'async', function () {
...
pathTestGroup.add(
    new Test('Unix 简单路径', 'async', function () {
...
pathTestGroup.add(
    new Test('Unix 根目录', 'async', function () {
        const p = new Path('/')
...
pathTestGroup.add(
    new Test('Unix 无扩展名', 'async', function () {
...
pathTestGroup.add(
    new Test('Unix 点文件', 'async', function () {
...
pathTestGroup.add(
    new Test('Unix 末尾斜杠', 'async', function () {
...
pathTestGroup.add(
    new Test('Unix 重复斜杠合并', 'async', function () {
        const p = new Path('/home//user///file.txt')
        this.assertEqual(p.fullPath, '/home/user/file.txt')
    })
)
...
pathTestGroup.add(
    new Test('Unix 反斜杠统一为正斜杠', 'async', function () {
        const p = new Path('/home\\user\\file.txt')
        this.assertEqual(p.fullPath, '/home/user/file.txt')
    })
)
...
pathTestGroup.add(
    new Test('Unix 点导航 (.)', 'async', function () {
        const p = new Path('/home/./user/./file.txt')
        this.assertEqual(p.fullPath, '/home/user/file.txt')
    })
)
...
pathTestGroup.add(
    new Test('Unix 绝对路径越界抛错', 'async', function () {
        this.assertThrows(() => new Path('/home/../../file.txt'))
    })
)

pathTestGroup.add(
    new Test('Unix 含空字符抛错', 'async', function () {
...
pathTestGroup.add(
    new Test('相对路径简单', 'async', function () {
...
pathTestGroup.add(
    new Test('相对路径当前目录前缀', 'async', function () {
        const p = new Path('./folder/file.txt')
        this.assertEqual(p.fullPath, 'folder/file.txt')
    })
)
...
pathTestGroup.add(
    new Test('相对路径返回上层', 'async', function () {
        const p = new Path('../folder/file.txt')
        this.assertEqual(p.fullPath, '../folder/file.txt')
    })
)
...
pathTestGroup.add(
    new Test('相对路径多层返回', 'async', function () {
...
pathTestGroup.add(
    new Test('相对路径保留多余..', 'async', function () {
...
pathTestGroup.add(
    new Test('相对路径含非法字符', 'async', function () {
...
pathTestGroup.add(
    new Test('相对路径含空字符抛错', 'async', function () {
...
pathTestGroup.add(
    new Test('空路径抛错', 'async', function () {
        this.assertThrows(() => new Path(''))
    })
)

pathTestGroup.add(
    new Test('UNC 路径抛错', 'async', function () {
        this.assertThrows(() => new Path('\\\\server\\share\\file.txt'))
    })
)

pathTestGroup.add(
    new Test('只有文件名 (相对)', 'async', function () {
...
pathTestGroup.add(
    new Test('以点开头的文件名', 'async', function () {
...
pathTestGroup.add(
    new Test('validate=false 跳过校验', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 仅驱动器盘符抛错', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 仅驱动器加反斜杠', 'async', function () {
        const p = new Path('C:\\')
        this.assertEqual(p.type, 'Windows')
...
pathTestGroup.add(
    new Test('Windows 仅驱动器加正斜杠', 'async', function () {
        const p = new Path('C:/')
        this.assertEqual(p.type, 'Windows')
        this.assertEqual(p.fullPath, 'C:\\')
    })
...
pathTestGroup.add(
    new Test('Windows 文件名尾部带点', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 路径含空格', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 路径含 Unicode 字符', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 路径含中文空格', 'async', function () {
...
pathTestGroup.add(
    new Test('Unix 路径含中文', 'async', function () {
...
pathTestGroup.add(
    new Test('Unix 文件名尾部带点', 'async', function () {
...
pathTestGroup.add(
    new Test('相对路径 纯点导航后为空', 'async', function () {
        const p = new Path('./.')
        this.assertEqual(p.fullPath, '')
    })
)
...
pathTestGroup.add(
    new Test('相对路径 多 .. 保留', 'async', function () {
        const p = new Path('../../../file.txt')
        this.assertEqual(p.fullPath, '../../../file.txt')
    })
)
...
pathTestGroup.add(
    new Test('相对路径 混合 . 和 ..', 'async', function () {
...
pathTestGroup.add(
    new Test('相对路径 以点开头的文件名', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 多级扩展名 2', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 长路径', 'async', function () {
...
pathTestGroup.add(
    new Test('Windows 变量含正则特殊字符', 'async', function () {
        // 变量名中的 . * + 等特殊字符应被正确转义
...
pathTestGroup.add(
    new Test('Unix 仅根目录斜杠', 'async', function () {
        const p = new Path('//')
        this.assertEqual(p.fullPath, '/')
    })
)
...
pathTestGroup.add(
    new Test('Unix 重复根目录斜杠', 'async', function () {
        const p = new Path('///')
        this.assertEqual(p.fullPath, '/')
    })
)
...
pathTestGroup.add(
    new Test('Unix 含空格路径', 'async', function () {
...
pathTestGroup.add(
    new Test('相对路径 空段被忽略', 'async', function () {
        const p = new Path('a//b///c')
...
pathTestGroup.add(
    new Test('相对路径 以 .. 开头且包含子目录', 'async', function () {
...
pathTestGroup.add(
    new Test('AST 结构（含变量节点）', 'async', function () {
        const p = new Path('C:\\%#AUTHOR#%\\%#TITLE#%[%#ID#%].mp4')
...
pathTestGroup.add(
    new Test('AST 变量格式参数', 'async', function () {
...
pathTestGroup.add(
    new Test('AST 点导航段语义', 'async', function () {
        const p = new Path('a/./b/../c')
...
pathTestGroup.add(
    new Test('resolve 变量替换', 'async', function () {
        const p = new Path('C:\\%#AUTHOR#%\\%#TITLE#%[%#ID#%].mp4')
...
pathTestGroup.add(
    new Test('resolve 未提供变量保持原样', 'async', function () {
...
pathTestGroup.add(
    new Test('resolve 变量格式参数', 'async', function () {
...
pathTestGroup.add(
    new Test('resolve 值含 format 方法', 'async', function () {
...
pathTestGroup.add(
    new Test('resolve 嵌套占位符', 'async', function () {
...
pathTestGroup.add(
    new Test('变量：纯变量段', 'async', function () {
        const p = new Path('%#A#%')
        this.assertEqual(p.type, 'Relative')
...
pathTestGroup.add(
    new Test('变量：相邻变量无字面间隔', 'async', function () {
...
pathTestGroup.add(
    new Test('变量：格式参数按首个冒号切分', 'async', function () {
...
pathTestGroup.add(
    new Test('变量：空格式参数', 'async', function () {
...
pathTestGroup.add(
    new Test('变量：空变量名合法', 'async', function () {
        // %##% 变量名为空，作为不透明节点不抛错
        const p = new Path('C:\\%##%\\file.txt')
...
pathTestGroup.add(
    new Test('变量：未闭合占位符视为字面文本', 'async', function () {
        // 只有前缀 %#、无后缀 #% → 整段作为字面量
...
pathTestGroup.add(
    new Test('变量：只有后缀 #% 视为字面文本', 'async', function () {
...
pathTestGroup.add(
    new Test('变量：名称可含单个 #（分隔符成对匹配）', 'async', function () {
...
pathTestGroup.add(
    new Test('变量：不能跨路径分隔符', 'async', function () {
...
pathTestGroup.add(
    new Test('变量：各路径类型均支持', 'async', function () {
...
pathTestGroup.add(
    new Test('resolve：变量值为空字符串不折叠分隔符', 'async', function () {
...
pathTestGroup.add(
    new Test('resolve：字面 % 与 # 不受影响', 'async', function () {
        // 未闭合的占位符不是变量，不会被替换
