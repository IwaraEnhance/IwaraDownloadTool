...
dateTestGroup.add(
    new Test('add 增加天数', 'async', function () {
...
dateTestGroup.add(
    new Test('add 增加月份', 'async', function () {
...
dateTestGroup.add(
    new Test('add 增加年份', 'async', function () {
        const d = new Date('2023-01-01T00:00:00')
...
dateTestGroup.add(
    new Test('add 增加小时', 'async', function () {
...
dateTestGroup.add(
    new Test('add 增加分钟', 'async', function () {
...
dateTestGroup.add(
    new Test('add 复合增加（月末钳位）', 'async', function () {
...
dateTestGroup.add(
    new Test('add 无参数不变', 'async', function () {
...
dateTestGroup.add(
    new Test('sub 减少天数', 'async', function () {
...
dateTestGroup.add(
    new Test('sub 减少月份', 'async', function () {
...
dateTestGroup.add(
    new Test('sub 减少年份', 'async', function () {
        const d = new Date('2023-01-01T00:00:00')
...
dateTestGroup.add(
    new Test('sub 减少导致月份回退', 'async', function () {
...
dateTestGroup.add(
    new Test('sub 复合减少（顺序执行）', 'async', function () {
        const d = new Date('2023-03-01T00:00:00')
...
dateTestGroup.add(
    new Test('sub 无参数不变', 'async', function () {
        const d = new Date('2023-06-15T12:30:45')
        const result = d.sub({})
        this.assertEqual(result.getTime(), d.getTime())
    })
...
dateTestGroup.add(
    new Test('format 默认格式', 'async', function () {
...
dateTestGroup.add(
    new Test('format 带时间的格式', 'async', function () {
        const d = new Date('2023-01-01T12:34:56')
...
dateTestGroup.add(
    new Test('format 无参数返回 ISO 字符串', 'async', function () {
        const d = new Date('2023-01-01T00:00:00')
...
dateTestGroup.add(
    new Test('format 中文格式', 'async', function () {
        const d = new Date('2023-01-01T12:34:56')
...
dateTestGroup.add(
    new Test('add 只传一个参数', 'async', function () {
        const d = new Date('2023-01-01T00:00:00')
...
dateTestGroup.add(
    new Test('add 参数含 undefined', 'async', function () {
...
dateTestGroup.add(
    new Test('add 闰年 2月29日', 'async', function () {
...
dateTestGroup.add(
    new Test('sub 闰年 2月29日', 'async', function () {
        const d = new Date('2024-02-29T00:00:00')
        const result = d.sub({ years: 1 })
...
dateTestGroup.add(
    new Test('add 跨年', 'async', function () {
...
dateTestGroup.add(
    new Test('sub 跨年', 'async', function () {
        const d = new Date('2023-01-15T00:00:00')
...
dateTestGroup.add(
    new Test('add sub 互逆运算', 'async', function () {
...
dateTestGroup.add(
    new Test('format 小时分钟秒', 'async', function () {
...
dateTestGroup.add(
    new Test('format 十二小时制', 'async', function () {
