...
emojiTestGroup.add(
    new Test('单个表情符号', 'async', function () {
...
emojiTestGroup.add(
    new Test('多个表情符号', 'async', function () {
        const template = '😀😃😄😁😆'
        const result = template.replaceEmojis('*')
...
// 表情符号序列测试（零宽度连接符）
emojiTestGroup.add(
    new Test('家庭表情序列', 'async', function () {
        const template = '家庭: 👨‍👩‍👧‍👦'
        const result = template.replaceEmojis('')
...
emojiTestGroup.add(
    new Test('职业性别序列', 'async', function () {
        const template = '👩‍⚕️👨‍⚕️'
        const result = template.replaceEmojis('_')
        this.assertEqual(result, '__')
    })
...
// 混合内容测试
emojiTestGroup.add(
    new Test('混合文本和表情', 'async', function () {
...
emojiTestGroup.add(
    new Test('表情在开头和结尾', 'async', function () {
        const template = '🎉派对开始🎊'
        const result = template.replaceEmojis('')
...
emojiTestGroup.add(
    new Test('无表情符号的字符串', 'async', function () {
...
// 替换参数测试
emojiTestGroup.add(
    new Test('替换为空字符串', 'async', function () {
...
emojiTestGroup.add(
    new Test('替换为多个字符', 'async', function () {
        const template = '😀😃😄'
...
emojiTestGroup.add(
    new Test('默认替换参数', 'async', function () {
...
emojiTestGroup.add(
    new Test('替换为null', 'async', function () {
...
emojiTestGroup.add(
    new Test('心形符号变体-全部替换', 'async', function () {
        const template = '💕💖💘💓💞🤍💜🖤❤️❤'
        const result = template.replaceEmojis('_')
...
emojiTestGroup.add(
    new Test('心形符号混在文本中', 'async', function () {
...
emojiTestGroup.add(
    new Test('心形符号+变异选择器', 'async', function () {
...
emojiTestGroup.add(
    new Test('多个心形连续排列', 'async', function () {
        const template = '💖💘💖💘'
        const result = template.replaceEmojis('-')
        this.assertEqual(result, '----')
    })
...
emojiTestGroup.add(
    new Test('带黑心的混合emoji', 'async', function () {
        const template = '😈🖤🎶'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('带角恶魔/天使表情', 'async', function () {
        const template = '😈😇👿👹👺'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('全肤色范围舞者', 'async', function () {
        const template = '💃🏻💃🏼💃🏽💃🏾💃🏿'
        const result = template.replaceEmojis('_')
...
emojiTestGroup.add(
    new Test('肤色手指指向', 'async', function () {
        const template = '👉🏻👈🏻'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('肤色修饰符混在文本中', 'async', function () {
        const template = '👉🏻👈🏻💕  Love'
        const result = template.replaceEmojis('')
...
emojiTestGroup.add(
    new Test('ZWJ红发女性', 'async', function () {
        const template = '👩‍🦰🔪'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('ZWJ烟花火焰', 'async', function () {
        const template = '🎇‍🔥'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('ZWJ舞伴+下划线', 'async', function () {
        const template = '👯‍_'
        const result = template.replaceEmojis('')
...
emojiTestGroup.add(
    new Test('ZWJ女性骑车', 'async', function () {
        const template = '👩‍🦰👨‍🦱👧‍🦳'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('化妆品类符号', 'async', function () {
        const template = '💄💋👗🎩'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('音乐/舞台类符号', 'async', function () {
        const template = '🎤🎶🎵🎼🥁🎹'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('星/光/宝石类符号', 'async', function () {
        const template = '✨🌠💎🌟⭐💫'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('武器工具类符号', 'async', function () {
...
emojiTestGroup.add(
    new Test('糖果食物类符号', 'async', function () {
        const template = '🍬🍭🍫🍿🍩'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('房屋/地标类符号', 'async', function () {
        const template = '🏘️🏠🏡🏢🏣🏤'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('医疗/身体类符号', 'async', function () {
        const template = '🩸🩹🩺💉🪦'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('手机科技类符号', 'async', function () {
        const template = '📱💻🖥️⌨️🖱️'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('动物爪子/兔子/小鸡', 'async', function () {
        const template = '🐾🐰🐥🐱🐶🐼'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('植物/自然符号', 'async', function () {
        const template = '🌸🍃🌀🔥🌺🌻🌹🌷'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('紫色几何图形', 'async', function () {
        const template = '🟣🟢🔴🟡🟠🟤'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '')
    })
...
emojiTestGroup.add(
    new Test('纯音符符号不替换', 'async', function () {
        const template = '♪♬♩♫'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '♪♬♩♫')
    })
...
emojiTestGroup.add(
    new Test('音符符号保持原文', 'async', function () {
...
emojiTestGroup.add(
    new Test('Emoji音符与文字音符区分', 'async', function () {
        const template = '🎶♪'
        const result = template.replaceEmojis('')
        this.assertEqual(result, '♪')
    })
...
// 复杂混合测试
emojiTestGroup.add(
    new Test('复杂混合场景', 'async', function () {
...
emojiTestGroup.add(
    new Test('重复表情符号', 'async', function () {
        const template = '😂😂😂重复😂😂😂'
...
emojiTestGroup.add(
    new Test('特殊符号误伤测试', 'async', function () {
...
emojiTestGroup.add(
    new Test('数学符号误伤测试', 'async', function () {
        const template = '数学符号: ∑ ∏ √ ∫ ∞ ≠ ≤ ≥'
        const result = template.replaceEmojis('_')
...
emojiTestGroup.add(
    new Test('箭头符号误伤测试', 'async', function () {
        const template = '箭头: → ← ↑ ↓ ↔ ↕ ↖ ↗ ↘ ↙'
        const result = template.replaceEmojis('_')
...
emojiTestGroup.add(
    new Test('货币符号误伤测试', 'async', function () {
        const template = '货币: € £ ¥ $ ¢ ₩ ₽ ₹'
        const result = template.replaceEmojis('_')
...
emojiTestGroup.add(
    new Test('标点符号误伤测试', 'async', function () {
        const template = '标点: 。，、；：「」『』【】《》〈〉！？'
        const result = template.replaceEmojis('_')
...
emojiTestGroup.add(
    new Test('数字和字母误伤测试', 'async', function () {
...
emojiTestGroup.add(
    new Test('混合误伤测试', 'async', function () {
...
// 性能测试
emojiTestGroup.add(
    new Test('大量表情符号性能', 'async', function () {
        const emojis = '😀😃😄😁😆😅😂🤣😊😇🙂🙃😉😌😍🥰😘😗😙😚😋😛😝😜🤪🤨🧐🤓😎🤩🥳😏😒😞😔😟😕🙁☹️😣😖😫😩🥺😢😭😤😠😡🤬🤯😳🥵🥶😱😨😰😥😓🤗🤔🤭🤫🤥😶😐😑😬🙄😯😦😧😮😲🥱😴🤤😪😵🤐🥴🤢🤮🤧😷🤒🤕🤑🤠😈👿👹👺🤡💩👻💀☠️👽👾🤖🎃😺😸😹😻😼😽🙀😿😾'
