...
// 简单替换性能测试 (10个变量)
performanceGroup.add(
    new Test('简单替换性能(10变量)', 'async', function () {
...
// 中等替换性能测试 (100个变量)
performanceGroup.add(
    new Test('中等替换性能(100变量)', 'async', function () {
...
// 大量替换性能测试 (1000个变量)
performanceGroup.add(
    new Test('大量替换性能(1000变量)', 'async', function () {
...
// 深度嵌套性能测试
performanceGroup.add(
    new Test('深度嵌套替换性能', 'async', function () {
        const variables: Record<string, string> = {}
