...
export class Database {
     ...
     */
    public async *iterateVideosBatched(batchSize: number = 500, predicate?: (video: VideoInfo) => boolean, sortBy?: 'UploadTime' | 'ID', direction: IDBCursorDirection = 'next'): AsyncGenerator<VideoInfo[], void, void> {
     ...
     */
    public async *iterateVideoKeysBatched(batchSize: number = 5000): AsyncGenerator<string[], void, void> {
     ...
     * }
     */
    public async *iterateTableBatched<T = unknown>(table: ExportableTable, batchSize: number = 500): AsyncGenerator<T[], void, void> {
        let lastKey: any = undefined
        let hasMore = true
     ...
     */
    private async downloadTextFile(filename: string, content: string, mimeType: string, mode: DownloadMode = 'auto', gmTimeout: number = 30 * 1000): Promise<void> {
     ...
     * });
     */
    public async exportToJsonFiles(table: ExportableTable, options: ExportToJsonOptions = {}): Promise<number> {
     ...
     */
    public async exportAllToJsonFiles(options: ExportToJsonOptions = {}): Promise<Record<ExportableTable, number>> {
